...
test('should convert line/column to position and back', () => {
...
test('should create parse errors with correct line and column', () => {
  const text = `ACCESSION: TEST001
RECORD_TITLE: Te™st
//`;
...
test('should handle mixed LF and position calculations correctly', () => {
