 ...
 * filename. (An ACCESSION containing a path separator, e.g. 'foo/bar', would
 * still trip the rule against a basename it never saw — a confusing error, not
 * a false pass.) Use validate() or validateContent() with the real filename for
 * that.
 *
